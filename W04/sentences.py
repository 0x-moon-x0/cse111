...
def main ():
    ...
    a = make_sentence (1, "past") + " " + get_prepositional_phrase (1)
    b = make_sentence (1, "present") + " " + get_prepositional_phrase (1)
    c = make_sentence (1, "future") + " " + get_prepositional_phrase (1)
    d = make_sentence (2, "past") + " " + get_prepositional_phrase (2)
    e = make_sentence (2, "present") + " " + get_prepositional_phrase (2)
    f = make_sentence (2, "future") + " " + get_prepositional_phrase (2)
